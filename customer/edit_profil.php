...
<form class="form-horizontal" action="" method="post">
  <table class="table table-striped">
        ...
        <tr>
          ...
          <td>
            <div class="col-sm-4">
            <input type="text" name="nohp" onkeypress="return hanyaAngka(event)" class="form-control" value="<?php echo $row['no_hp']; ?>" placeholder="NOMOR HP" required>
          </div>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <div class="col-sm-4">
            <input type="text" name="email" class="form-control" value="<?php echo $row['email']; ?>" placeholder="EMAIL" required>
          </div>
          </td>
        </tr>
        <tr>
