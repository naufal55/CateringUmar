...
<nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="daftar pesanan.php" >Daftar pesanan</a></li> 
      </ul>
...
<div class="table-responsive">
  <table class="table table-striped">
    ...
    $user=$_SESSION['admin'];
      ...
      $ngecek = mysqli_query($koneksi, "SELECT * FROM pesanan");
      ...
      if($baris == 0){
        ...
        echo '
          ...
          <td>
            <a href="daftar pesanan.php?aksi=delete&id_beli='.$bag['id_beli'].'" title="Hapus pesanan pelanggan" onclick="return confirm(\' Apakah anda yakin ingin membatalkan pesanan pelanggan?\')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
          </td>
          <td>'
          ;
        }
